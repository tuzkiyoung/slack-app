...
type SocketmodeHandlerFunc func(*socketmode.Event, *socketmode.Client)
...
func NewsSocketmodeHandler(client *socketmode.Client) *SocketmodeHandler {
	...
	return &SocketmodeHandler{
		...
		Default: func(e *socketmode.Event, c *socketmode.Client) {
...
func (r *SocketmodeHandler) Handle(et socketmode.EventType, f SocketmodeHandlerFunc) {
...
func (r *SocketmodeHandler) dispatcher(evt socketmode.Event) {
	var ishandled bool
...
func (r *SocketmodeHandler) socketmodeDispatcher(evt *socketmode.Event) bool {
...
func (r *SocketmodeHandler) interactionDispatcher(evt *socketmode.Event) bool {
...
func (r *SocketmodeHandler) eventAPIDispatcher(evt *socketmode.Event) bool {
	var ishandled bool = false
	...
	innerEventType := eventsAPIEvent.InnerEvent.Type
...
func (r *SocketmodeHandler) slashCommandDispatcher(evt *socketmode.Event) bool {
	var ishandled bool = false
